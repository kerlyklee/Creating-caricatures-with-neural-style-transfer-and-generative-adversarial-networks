...
import cv2
import os
#C:/Users/Admin/Thesis/NeuralStyleTransfer/Caricature/
parser = argparse.ArgumentParser(description='Creating Caricatures')
parser.add_argument('--cont_img', default='kerlyklee@tensorflow-1-vm/home/Beyonce.jpg', type=str, help='Path to original image')
parser.add_argument('--style_img', default='kerlyklee@tensorflow-1-vm/home/BeyonceC.jpg', type=str, help='Path to wished style image')
