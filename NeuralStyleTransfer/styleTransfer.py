...
parser.add_argument('--cont_img', default='//home/Beyonce.jpg', type=str, help='Path to original image')
parser.add_argument('--style_img', default='//home/BeyonceC.jpg', type=str, help='Path to wished style image')
