...
def load_arguments():
    ...
    parser.add_argument('-ap', '--acc_plot', type=str, default='acc_plot.png', help='Path to accuracy plot')
    parser.add_argument('-lp', '--loss_plot', type=str, default='loss_plot.png', help='Path to loss plot')
