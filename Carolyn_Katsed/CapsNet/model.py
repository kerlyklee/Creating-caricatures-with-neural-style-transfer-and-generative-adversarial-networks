...
class ModelHumorPrediction(ModelBase):
    """
        ModelHumorPrediction.
    ...
    def _build_main_network(self, images, conv_2_dropout):
        """
            This method is used to create the convolution and the CapsNet on the top
            **input:
    ...
    def predict(self, images):
        ...
        caps2, classes = self.sess.run(tensors,
            feed_dict={
            self.tf_images: images,
            self.tf_conv_2_dropout: 1.
        })
...
if __name__ == '__main__':
    model_humor_prediction = ModelHumorPrediction("test", output_folder=None)
    model_humor_prediction.init()
