...
def train():
    ...
    trainer_d = tf.train.RMSPropOptimizer(learning_rate=0.0012).minimize(d_loss, var_list=d_vars)
    trainer_g = tf.train.RMSPropOptimizer(learning_rate=0.0012).minimize(g_loss, var_list=g_vars)
